...
const betterCursor_1 = __importDefault(__webpack_require__(/*! ./betterCursor */ "./src/betterCursor.ts"));
...
class cursor {
    constructor(id, size = "24px", mass = 75, trackingPeriod = 100) {
        ...
        this.setShape = (shape, elmnt = this._currentHoverElmnt, hideCursor = false) => {
            switch (shape) {
                ...
                default:
                    ...
                    this.cursorElement.style.marginLeft = "0";
                    this.cursorElement.style.marginTop = "0";
                    if (this._currentSnapElmnt) {
                        this._lastSnapElmnt.style.transition = "200ms ease";
                        this._currentSnapElmnt.style.transform = "translate3d(0,0,0)";
                        this._currentSnapElmnt.style.scale = "1";
                    }
        ...
        this.trkPer = trackingPeriod;
        {
            ...
            this.cursorElement.style.transition = `${this.cursorMass}ms ease`;
            this.cursorElement.style.width = this.currentCursorWidth;
            this.cursorElement.style.height = this.currentCursorHeight;
            this.cursorElement.style.borderRadius = this.currentCursorRadius;
            this.cursorElement.style.backgroundColor = "hsla(0, 0%, 0%, 0.3)";
