...
const betterpointer_1 = __importDefault(__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'betterpointer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
...
window.onload = () => {
    init_UI(new betterpointer_1.default("custom-cursor"));
};
